...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      //
      //var homeHtmlToInsertIntoMainPage = insertProperty(html, "chosenCategoryShortName", name);
...
// Load the about contents view
dc.loadAboutContents = function () {
  showLoading("#main-content");
  $ajaxUtils.sendGetRequest(
    allCategoriesUrl,
    myStar);
...
// build categories view HTML to be inserted into page
function buildAboutViewHtml(categories,
                                 aboutHtml,
                                 categoryHtml) {
  ...
  var x = Math.floor((Math.random() * 5) + 1);
    ...
    var html2 = aboutHtml;
      ...
      if (x==1){
      html2 =
      insertProperty(html2, "star1", "fa fa-star");
      html2 =
      insertProperty(html2, "star2", "fa fa-star-o");
      html2 =
      insertProperty(html2, "star3", "fa fa-star-o");
      html2 =
      ...
      insertProperty(html2, "star1", "fa fa-star");
      html2 =
      insertProperty(html2, "star2", "fa fa-star");
      html2 =
      insertProperty(html2, "star3", "fa fa-star-o");
      html2 =
      insertProperty(html2, "star4", "fa fa-star-o");
      ...
      insertProperty(html2, "star2", "fa fa-star");
      html2 =
      insertProperty(html2, "star3", "fa fa-star");
      html2 =
      insertProperty(html2, "star4", "fa fa-star-o");
      html2 =
      insertProperty(html2, "star5", "fa fa-star-o");
...
function myStar(categories) {
  
  // Load title snippet of about page
  $ajaxUtils.sendGetRequest(
    aboutHtml,
    function (aboutHtml) {
      // Retrieve single category snippet
